...
public record PopupResult(bool WasDismissedByTappingOutsideOfPopup) : IPopupResult;

/// <summary>
/// Represents the result of a popup when T is a reference type.
/// </summary>
/// <typeparam name="T">Popup result type</typeparam>
public record PopupResult<T> : PopupResult, IPopupResult<T>
{
	/// <summary>
...
/// <summary>
/// Exception thrown when PopupResult cannot cast Result to the specified type.
/// </summary>
/// <param name="message"></param>
public class PopupResultException(string message) : InvalidCastException(message);